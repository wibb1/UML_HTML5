...
(function (document, window, index) {
  ...
  Array.prototype.forEach.call(forms, function (form) {
    ...
    if (isAdvancedUpload) {
      form.classList.add("has-advanced-upload"); // letting the CSS part know if drag&drop is supported by the browser
...
//********************************************************************** */
    ...
    // Firefox focus bug fix for file input - from internet
